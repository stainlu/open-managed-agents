...
First-party bridge between Telegram chats and `open-managed-agents`.
...
|---|---|---|
| `OPENCLAW_ORCHESTRATOR_URL` | `http://open-managed-agents-orchestrator:8080` | Where the orchestrator HTTP API lives. |
