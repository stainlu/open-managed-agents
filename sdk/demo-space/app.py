...
A thin Gradio chat UI in front of an Open Managed Agents orchestrator.
...
# Open Managed Agents — Live Demo

A Gradio UI wired to a real [Open Managed Agents](https://github.com/stainlu/open-managed-agents) orchestrator.
...
with gr.Blocks(title="Open Managed Agents — Demo") as demo:
    ...
    gr.Markdown(
        "— Source: [github.com/stainlu/open-managed-agents](https://github.com/stainlu/open-managed-agents)"
    )
