...
workspace backend, with metadata still passed explicitly. Managed event-log
...
the Flue driver beyond prompt calls, then promoting the Cloudflare/Flue factory
into a real Worker/Durable Object runtime path.
